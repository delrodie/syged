 ...
 * Stickage
 *
 * @ORM\Table(name="stickage")
 * @ORM\Entity(repositoryClass="AppBundle\Repository\StickageRepository")
 */
class Stickage
{
    /**
     ...
     * @var int
     *
     * @ORM\Column(name="stockinitial", type="integer", nullable=true, options={"default": 0})
     */
